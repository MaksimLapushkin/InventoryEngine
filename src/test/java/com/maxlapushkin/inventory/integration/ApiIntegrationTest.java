...
class ApiIntegrationTest extends PostgresContainerTestBase {
    ...
    void shouldRunHappyPathFlow() throws Exception {
        ...
        MvcResult orderResult = mockMvc.perform(post("/api/orders")
                ...
                .andExpect(jsonPath("$.deliveryCity").value("Budapest"))
                .andExpect(jsonPath("$.deliveryPostalCode").value("1051"))
                .andExpect(jsonPath("$.customerPhone").value("+36123456789"))
                .andReturn();
